...
const Footer: React.FC<Props> = ({ storeLinks, brandTagline, bpomNumber }) => {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-24">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-sm font-bold leading-relaxed mb-8 opacity-70">
              {brandTagline || 'Bold, Natural, Indonesian. Since 2020.'}
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href={storeLinks.shopee} className="text-sm font-black hover:text-brand-yellow transition-colors">SHOPEE</a></li>
              <li><a href={storeLinks.tokopedia} className="text-sm font-black hover:text-brand-yellow transition-colors">TOKOPEDIA</a></li>
              <li><a href={storeLinks.tiktok} className="text-sm font-black hover:text-brand-yellow transition-colors">TIKTOK</a></li>
            </ul>
          </div>

          <div>
            <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-brand-yellow mb-8">Get In Touch</h4>
            <a href={storeLinks.whatsapp} className="inline-block bg-brand-yellow text-brand-blue px-8 py-4 rounded-full text-[10px] font-black uppercase tracking-widest hover:bg-white transition-all">
              Chat Support
            </a>
          </div>
        </div>
